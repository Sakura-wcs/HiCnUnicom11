...
[[ $all_username_password == "18691311316@081700" ]] && echo "账号密码参数错误" && exit 1

# 登录失败尝试修改以下这个appId的值为抓包获取的登录过的联通app,也可使用传入参数 appId@*************
appId=86b8be06f56ba55e9fa7dff134c6b16c9a65c928789ac032f08546224dc0b0f202027773fdda0ab0f333d77e68c3c5204f34390cbe515206fbed6bb8ff8b29de1343ae1f090fb85b8c396236464128e1
